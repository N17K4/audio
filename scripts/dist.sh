...
log_step "产物清单"
echo "macOS 产物："
ls -lh dist/mac-arm64/AI*.app 2>/dev/null || ls -lh dist/mac-*/AI*.app 2>/dev/null || echo "  未找到 .app"
echo ""
echo "Windows 产物："
ls -lh dist/win-*/AI*.exe 2>/dev/null || echo "  未找到 .exe"
echo ""
echo "Zip 文件："
find dist -maxdepth 2 -name "AI-Workshop-*.zip" -exec ls -lh {} \;
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "下一步："
